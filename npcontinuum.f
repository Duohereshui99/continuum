...
ccccccc        
        module mesh                   !积分格点相关
           ...
           real*8::h                       !步长
           integer,parameter::nint=5000                   !格点数
        end module
ccccccc
        module system
            use parameter
            implicit none
            real*8,parameter::mass_1=1.d0           !组分质量和约化质量
            real*8,parameter::mass_2=1.d0
            real*8::mu                  
            real*8,parameter::z1=1d0                !带电量
            real*8,parameter::z2=0d0
            real*8::eta                              !Sommerfeld参数
            real*8,parameter::E=0.55662989327738921d0!5d0  !能量(Ecm,MeV)
...
ccccccc     
        module potpar         !!potential parameters 
            implicit none
            real*8,parameter::v0=-72.17d0      !!gausspot势参数,没有下划线
